...
class SymbolBase(Base):
    ...
    def gather_candidates(self, context):
        ...
        results = self.vim.call('denite_coc_workspace_symbols#try_get_results')
        if results is None:
            return []
    ...
    def reinit(self):
        ...
        self.result = set()
        self.vim.call('denite_coc_workspace_symbols#set_current_server')

    def get_newly_added(self, results):
        info("get results: %s" % str(results))
